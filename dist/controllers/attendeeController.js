...
export const importAttendeesFunc = async (attendees) => {
...
export const attendanceDashboard = async (req, res) => {
    try {
...
export const accreditParticipant = async (req, res) => {
    try {
        await Attendee.updateOne({ _id: req.body._id }, { $set: { accredited: true, timeAccredited: new Date() } });
...
export const getAccreditedParticipants = async (req, res) => {
    try {
