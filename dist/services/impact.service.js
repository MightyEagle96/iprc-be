...
class ImpactService {
    ...
    async getParticipants({ page = 1, limit = 20, search = "", classCategory, ageGrade, }) {
    ...
    async getDashboardStats() {
        const [total, members, nonMembers, classDistribution, ageDistribution, genderDistribution,] = await Promise.all([
